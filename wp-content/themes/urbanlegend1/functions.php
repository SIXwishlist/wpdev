...
// LOAD JAVASCRIPTS
	wp_enqueue_script('jquery');
	 wp_enqueue_script('swapFeatured', get_bloginfo('template_url')."/js/swapFeatured.js",array('jquery')); 
	 wp_enqueue_script('hideSearch',get_bloginfo('template_url')."/js/hideSearch.js",array('jquery'));
	wp_enqueue_script('fancybox',get_bloginfo('template_url')."/js/fancybox-1.3.1.pack.js",array('jquery'));
	
 // only need comment script on singular pages
	if (!is_singular() ): 
		wp_deregister_script( 'comment-reply' );
	endif;
		// only need cforms script on form page
	if (!is_page('Contact')):
...
require_once('google-hilite.php');
